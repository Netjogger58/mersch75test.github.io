...
function initializeSiteLanguage() {
    ...
    const translations = {
        lb: {
            ...
            newsMenBody: 'D\'Pläng fir déi kommend Saison sinn nach net ganz ofgeschloss, mee d\'Preparatioun leeft schonn: Bis de 14. August trainéieren eis Häre mat Lafunitéiten am Park, a vum 17. August un geet et an der Hal weider. Mat Ausdauer, Teamgeescht a Fokus leeë si elo d\'Basis fir d\'Saison 2026/2027. 💛💙',
        ...
        fr: {
            ...
            newsMenBody: 'Les plans pour la saison à venir ne sont pas encore totalement finalisés, mais la préparation a commencé : jusqu’au 14 août, nos hommes travaillent leur endurance en courant au parc, puis ils reprendront en salle dès le 17 août. Ils posent ainsi les bases de la saison 2026/2027 avec concentration et esprit d’équipe. 💛💙',
        ...
        de: {
            ...
            newsMenBody: 'Die Pläne für die kommende Saison sind noch nicht vollständig abgeschlossen, doch die Vorbereitung läuft bereits: Bis zum 14. August trainieren unsere Männer mit Laufeinheiten im Park, ab dem 17. August geht es in der Halle weiter. Mit Ausdauer, Teamgeist und Fokus legen sie jetzt die Grundlage für die Saison 2026/2027. 💛💙',
        ...
        en: {
            ...
            newsMenBody: 'Plans for the coming season are not yet fully finalised, but preparation is already under way: our men will train with running sessions in the park until 14 August, before returning to the sports hall from 17 August. Endurance, teamwork and focus will lay the foundations for the 2026/2027 season. 💛💙',
        ...
        pt: {
            ...
            newsMenBody: 'Os planos para a próxima época ainda não estão totalmente concluídos, mas a preparação já começou: até 14 de agosto, os nossos homens treinam com sessões de corrida no parque e, a partir de 17 de agosto, regressam ao pavilhão. Resistência, espírito de equipa e concentração vão criar as bases para a época 2026/2027. 💛💙',
